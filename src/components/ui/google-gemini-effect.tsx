...
const baseTransition: Transition = {
  duration: 0.9,
  ease: [0.42, 0, 0.58, 1], // cubic-bezier equivalent to "ease-in-out"
};
...
export const GoogleGeminiEffect = ({
  ...
  useEffect(() => {
    ...
    // إضافة event listener لمراقبة تغيير الحجم
  ...
  const safePathLength = (i: number) => pathLengths?.[i] ?? 1;
      ...
      >
        ...
        <motion.path
          ...
          style={{
            ...
            filter: 'brightness(1.5) contrast(1.3) saturate(1.2) drop-shadow(0 0 8px #ff9eb580)',
          }}
          transition={transitionForIndex(0)}
        />
        
        {/* الخط الثاني - برتقالي مضيء */}
        <motion.path
          ...
          style={{
            ...
            filter: 'brightness(1.5) contrast(1.3) saturate(1.2) drop-shadow(0 0 8px #ffe8a380)',
          }}
          transition={transitionForIndex(1)}
        />
        
        {/* الخط الثالث - أزرق فاتح مضيء */}
        <motion.path
          ...
          style={{
            ...
            filter: 'brightness(1.5) contrast(1.3) saturate(1.2) drop-shadow(0 0 8px #c4d3ff80)',
          }}
          transition={transitionForIndex(2)}
        />
        
        {/* الخط الرابع - أزرق متوسط مضيء */}
        <motion.path
          ...
          style={{
            ...
            filter: 'brightness(1.5) contrast(1.3) saturate(1.2) drop-shadow(0 0 8px #76c4ff80)',
          }}
          transition={transitionForIndex(3)}
        />
        
        {/* الخط الخامس - أزرق غامق مضيء */}
        <motion.path
          ...
          style={{
            ...
            filter: 'brightness(1.5) contrast(1.3) saturate(1.2) drop-shadow(0 0 8px #3a9cff80)',
          }}
